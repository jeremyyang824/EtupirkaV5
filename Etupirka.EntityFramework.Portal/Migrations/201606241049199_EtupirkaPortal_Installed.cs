namespace Etupirka.EntityFramework.Portal.Migrations
{
    ...
    public partial class EtupirkaPortal_Installed : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_SysRole_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_SysUser_MayHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_SysTenant_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpUsers", t => t.CreatorUserId)
                .ForeignKey("dbo.AbpUsers", t => t.DeleterUserId)
